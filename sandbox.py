...
#######################################################################
from algorithms.se3_control import SE3Control
from algorithms.world_traj import WorldTraj
#######################################################################
...
file = Path(inspect.getsourcefile(lambda:0)).parent.resolve() / 'tests' / filename
